...
def Gerner_TAI_LO_img():
    ...
    os.system(
        f'python run.py  \
            ...
            -t $(cat /proc/cpuinfo | grep "processor" |  wc -l)\
            -b 3 --output_dir {data_TAI_LO_path}'
    )
...
def Gerner_HAN_LO_img():
    ...
    os.system(
        f'python run.py  \
            ...
            -t $(cat /proc/cpuinfo | grep "processor" |  wc -l)\
            -b 3 --output_dir {data_HAN_LO_path}'
    )
