...
def Gerner_TAI_LO_img():
    ...
    os.system(f'python run.py  -c 10000 -i dicts/TAI_LO/TAI_LO_corpus.txt -fd fonts/test_font/TAI_LO/ -b 3 -t $(cat /proc/cpuinfo | grep "processor" |  wc -l) -f 48 --output_dir {test_TAI_LO_img_path}')
