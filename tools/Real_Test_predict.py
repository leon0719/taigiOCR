...
conbined_list = [test_ch_img_path,test_en_img_path,test_HAN_LO_img_path,test_POJ_img_path]
...
for lang in conbined_list:
    ...
    os.system(f'python3 tools/infer_rec.py -c configs/rec/PP-OCRv3/PP-OCRv3_rec.yml -o Global.pretrained_model=output/my_ocr_model/best_accuracy  Global.infer_img={lang}')
