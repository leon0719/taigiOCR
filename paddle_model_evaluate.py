...
os.system(
    f'python3 tools/infer_rec.py -c configs/rec/PP-OCRv3/multi_language/chinese_cht_PP-OCRv3_rec.yml -o Global.pretrained_model=/workspace/PaddleOCR/Pretrained_model/en-cht-Pretrained/best_accuracy Global.infer_img=/workspace/test_data/Hanji/Hanji_img')
